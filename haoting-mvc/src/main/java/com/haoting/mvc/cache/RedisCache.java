package com.haoting.mvc.cache;

import com.haoting.mvc.exception.CacheException;
...
public class RedisCache<T> {
	...
	public void deletePattern(String key) {
		LOGGER.debug("delete key pattern [{}]", key);
		try {
			...
			LOGGER.error("delete key pattern [{}] exception!", key, t);
			throw new CacheException(t);
		}
	}
