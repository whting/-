				...
				<div class="modal-body">
					<form id="_editForm" class="form-horizontal" role="form"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix help-validate">
									<input id="_url" name="url" type="text" class="form-data col-xs-10 col-sm-9" placeholder="URL" maxlength="64"/>
								</div>
							</div>
	...
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
		jQuery(function($) {
			...
			function fontCss(treeId, treeNode) {
				var isEnable = treeNode.isEnable;
				if(!isEnable){
