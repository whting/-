		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					<%--<li class="">
						<a data-url="/admin/app" href="#/admin/app" class="">
							<i class="menu-icon fa fa-plus-circle blue"></i>
					...
					<li class="">
						<a data-url="/admin/user" href="#/admin/user" class="">
							<i class="menu-icon fa fa-plus-circle blue"></i>
					...
					<li class="">
						<a data-url="/admin/role" href="#/admin/role" class="">
							<i class="menu-icon fa fa-plus-circle blue"></i>
					...
					<li class="">
						<a data-url="/admin/permission" href="#/admin/permission" class="">
							<i class="menu-icon fa fa-plus-circle blue"></i>
		...
		<script type="text/javascript">
			jQuery(function ($) {
				...
				$.getJSON("${_path}/admin/admin/menu?v=" + Math.random(), function(d) {
					$("#_permission").attr("data",d.data.noPermissions)
   					$('.nav-list').append(tree(d.data.menuList));
				});
